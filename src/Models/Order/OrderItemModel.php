...
class OrderItemModel extends Model
{
    ...
    public function insertOrderItem(int $product_id, int $order_id, float $price, int $quantity): bool
    {
        try {
            $insertOrderItemQuery = "INSERT INTO order_items (product_id,order_id,price,quantity) VALUES (?,?,?,?)";
